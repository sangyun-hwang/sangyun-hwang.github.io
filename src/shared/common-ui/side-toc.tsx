...
import { getScrollTop, type TocItem } from "@/entities/post/lib/utils/toc.util";
...
export const SideToc = ({ toc }: TocProps) => {
  ...
  return (
    <aside className="absolute -top-50 -mb-25 h-[calc(100%+150px)] left-full hidden xl:block">
      <div className="sticky bottom-0 top-50 z-10 ml-16 mt-50 w-50 overflow-y-auto overflow-x-hidden">
